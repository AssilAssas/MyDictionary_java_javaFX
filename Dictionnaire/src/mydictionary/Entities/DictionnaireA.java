...
public class DictionnaireA {
     ...
     public DictionnaireA(String mot, String type, String traduction, String exemple1, String exemple2) {
          this.mot = mot;
          this.type = type;
     ...
     public DictionnaireA(String type, String traduction, String exemple1, String exemple2) {
          this.type = type;
          this.traduction = traduction;
          this.exemple1 = exemple1;
          this.exemple2 = exemple2;
